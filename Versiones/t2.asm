...
; Autor: Dairo Rodriguez - Versión 2.0
;============================================================
.model small
.stack 100h
.data
...
DrawBorders proc
    mov cx, SCREEN_HEIGHT ; Número de filas de la pantalla
    mov dx, 0
BucleBordes:
    mov ah, 02h
    mov bh, 0
...
InitGame proc
    ...
    mov speed, 5
    mov cl, 0
InitLoop: ; Inicializar obstáculos
    mov al, cl ; Usar cl para la fila del obstáculo
    mov obsY[si], al ; Asignar fila
    mov obsX[si], 30 ; Columna inicial
